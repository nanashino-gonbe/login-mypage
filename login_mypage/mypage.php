...
if(empty($_SESSION['id'])) {
    try{
        ...
        die("<p>申し訳ございません。現在サーバーが込み合っており一時的にアクセスが出来ません。<br>しばらくしてから再度ログインしてください。</p><a href='http://localhost/login_mypage/login.php'>ログイン画面へ</a>");
    }
    ...
    <main>
        <div class="box">
            ...
            <form action="mypage_hensyu.php" method="post">
                ...
                <input type="submit" class="submit_btn" size="35" value="編集する">
            </form>
        </div>
    </main>
    <footer>
